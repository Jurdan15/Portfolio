...
namespace Chatbot_Admin
{
    public partial class Fully_Answered : ContentPage
    {
        ...
        {
            await Navigation.PushAsync(new FullyAnsweredBreakdown());
        }
        ...
        private async Task LoadResponseStatistics()
        {
            try
            {
                ...
                const string getResponsesQuery = "SELECT fully_answered FROM feedback WHERE timely_response IS NOT NULL";
