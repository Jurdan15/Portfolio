...
if (isset($_GET['BarcodeScanner1'])) {
    ...
    $checkBorrowedSql = "SELECT * FROM borrowed_books WHERE barcode = '$barcode'";
    ...
    if ($borrowedResult->num_rows > 0) {
        ...
        if ($result->num_rows > 0) {
           ...
           $insertBorrowedSql = "INSERT INTO borrowed_books (barcode) VALUES ('$barcode')";
            ...
            $insertSql = "INSERT INTO barcodes (barcode,Book_Status) VALUES ('$barcode','Available')";
